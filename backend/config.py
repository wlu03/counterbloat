...
class Retrieval(BaseModel):
    ...
    # When set, a corpus no larger than this many passages is shown whole instead of being
    # searched. Off by default: on CLIMATE-FEVER it lowered the share of claims the pipeline
    # would commit to from 23% to 12%, because more passages gave the updater more reason to
    # abstain. See docs/evaluation_protocol.md.
    show_whole_corpus_under: int = 0
